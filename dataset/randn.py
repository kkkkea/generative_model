...
class RandomNDataset(Dataset):
    def __init__(
        ...
        conditions: Union[int, List, str] = None,
        seeds=None,
        ...
        if seeds is not None:
            ...
            self.num_seeds = (
                max_num_instances + self.num_conditons - 1
            ) // self.num_conditons
    ...
    def __getitem__(self, idx):
        ...
        latent = torch.randn(
            self.latent_shape, generator=generator, dtype=torch.float32
        )
...
class ClassLabelRandomNDataset(RandomNDataset):
    def __init__(
        ...
        super().__init__(
            latent_shape, conditions, seeds, max_num_instances, num_samples_per_instance
        )
